...
class ApplicantApplicationStatus {
    ...
    Map<String, dynamic> toJson() =>
    {
           ...
           if(application_status_id != null) 'application_status_id': application_status_id,
...
Future<List<ApplicantApplicationStatus>> fetchApplicantApplicationStatuss() async {
    final response =
        await http.get(Uri.parse(AppConfig.hrmApiUrl + '/sms/hrm/applicant_application_statuss'),
    ...
    if (response.statusCode == 200) {
        ...
        List<ApplicantApplicationStatus> applicantApplicationStatuss = await resultsJson
            .map<ApplicantApplicationStatus>((json) => ApplicantApplicationStatus.fromJson(json))
            .toList();
...
Future<ApplicantApplicationStatus> fetchApplicantApplicationStatus(String id) async {
    final response =
        await http.get(Uri.parse(AppConfig.hrmApiUrl + '/sms/hrm/applicant_application_statuss/$id'),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
          'accept': 'application/json',
          'API-Key': AppConfig.hrmApiKey,
    ...
    if (response.statusCode == 200) {
        var resultsJson = json.decode(response.body).cast<Map<String, dynamic>>();
        ApplicantApplicationStatus applicantApplicationStatus = await resultsJson
            .map<ApplicantApplicationStatus>((json) => ApplicantApplicationStatus.fromJson(json));
        return applicantApplicationStatus;
    } else {
        throw Exception('Failed to load ApplicantApplicationStatus');
...
Future<http.Response> createApplicantApplicationStatus(ApplicantApplicationStatus applicantApplicationStatus) async {
...
Future<http.Response> updateApplicantApplicationStatus(ApplicantApplicationStatus applicantApplicationStatus) async {
...
Future<http.Response> deleteApplicantApplicationStatus(String id) async {
    final http.Response response = await http.delete(
        Uri.parse(AppConfig.hrmApiUrl + '/sms/hrm/applicant_application_statuss/$id'),
        headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'API-Key': AppConfig.hrmApiKey,
        },

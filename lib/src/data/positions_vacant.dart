...
Future<List<PositionsVacant>> fetchPositionsVacants() async {
    final response =
        await http.get(Uri.parse(AppConfig.hrmApiUrl + '/sms/hrm/positions_vacants'),
...
Future<PositionsVacant> fetchPositionsVacant(String id) async {
    final response =
        await http.get(Uri.parse(AppConfig.hrmApiUrl + '/sms/hrm/positions_vacants/$id'),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
          'accept': 'application/json',
          'API-Key': AppConfig.hrmApiKey,
...
Future<http.Response> createPositionsVacant(PositionsVacant positionsVacant) async {
...
Future<http.Response> updatePositionsVacant(PositionsVacant positionsVacant) async {
